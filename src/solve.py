...
from cupyx.scipy.sparse.linalg import splu as splu_gpu
from scipy.sparse.linalg import splu as splu_cpu

def compute_solution_gpu(solution:np.ndarray, iteration_matrix:scipy.sparse._csc.csc_matrix, time_steps:int, dx:float):
    '''
    ...
    LU_method = splu_gpu(iteration_matrix)
...
def compute_solution_cpu(solution:np.ndarray, iteration_matrix:scipy.sparse._csc.csc_matrix, time_steps:int, dx:float):
    '''
    Computes the numerical scheme's solution on the CPU using LU decomposition.
    ...
    # Compute the LU factorization of the iteration matrix
    LU_method = splu_cpu(iteration_matrix)
